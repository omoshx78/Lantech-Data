      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #f58634, #d8762e)' }}>
        ...
        <div className="relative max-w-6xl mx-auto px-5 pt-20 pb-24">
          <Reveal>
            ...
            <Link to="/shop" className="mt-8 inline-flex items-center gap-2 rounded-full bg-white font-semibold px-6 py-3.5 hover:bg-orange-50 hover:shadow-lg transition-all" style={{ color: '#d8762e' }}>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          {features.map((f, i) => (
            <Reveal key={f.title} delay={i * 100}>
              <div className="group rounded-2xl border border-slate-200 p-7 bg-white hover:shadow-xl hover:shadow-[#F58634]/10 hover:-translate-y-1 hover:border-[#F58634]/30 transition-all h-full">
                <div className="h-12 w-12 rounded-xl flex items-center justify-center transition-transform group-hover:scale-110" style={{ background: '#fef3eb' }}>
      ...
      <section className="border-t border-slate-200 py-20" style={{ background: 'linear-gradient(180deg, #FFF8F2, #FEF3EB)' }}>
        <Reveal>
          <div className="max-w-4xl mx-auto px-5 text-center">
            ...
            <Link
              to="/shop"
              className="mt-6 inline-flex items-center gap-2 rounded-full text-white font-semibold px-6 py-3.5 transition-all hover:shadow-lg hover:-translate-y-0.5"
