  ...
  return (
    <div>
      ...
      <section className="max-w-6xl mx-auto px-5 py-20 grid md:grid-cols-2 gap-6">
        <Reveal>
          <div
            className="rounded-2xl p-8 border border-slate-200 h-full transition-all hover:shadow-xl hover:-translate-y-1"
            style={{ background: 'linear-gradient(160deg, #f0f0f7, white)' }}
          >
        ...
        <Reveal delay={120}>
          <div
            className="rounded-2xl p-8 border border-slate-200 h-full transition-all hover:shadow-xl hover:-translate-y-1"
            style={{ background: 'linear-gradient(160deg, #fef3eb, white)' }}
          >
        ...
        <div className="max-w-6xl mx-auto px-5">
          <Reveal>
            <div className="text-center max-w-xl mx-auto">
              <span className="inline-flex items-center rounded-full bg-white text-[#3E4095] text-xs font-semibold px-3 py-1.5">Our values</span>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            {values.map((v, i) => (
              <Reveal key={v.title} delay={i * 100}>
                <div className="group bg-white rounded-2xl border border-slate-200 p-7 h-full hover:shadow-xl hover:shadow-[#F58634]/10 hover:-translate-y-1 hover:border-[#F58634]/30 transition-all">
                  <v.icon size={26} style={{ color: '#f58634' }} className="transition-transform group-hover:scale-110 group-hover:-rotate-6" />
